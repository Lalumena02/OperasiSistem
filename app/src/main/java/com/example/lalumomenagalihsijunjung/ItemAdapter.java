...
public class ItemAdapter extends ArrayAdapter {
    ...
    public ItemAdapter(Context context, ArrayList<DataOperasiSistem> data) {
        super(context, R.layout.item_row_list, data);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = layoutInflater.inflate(R.layout.item_row_list, parent, false);
